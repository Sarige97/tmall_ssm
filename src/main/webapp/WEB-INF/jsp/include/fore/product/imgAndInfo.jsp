...
<div class="imgAndInfo">
    ...
    <div class="imgInimgAndInfo">
        ...
        <div class="smallImageDiv">
            <c:forEach items="${product.productSingleImageList}" var="productImage">
                <img src="img/productSingle_small/${productImage.id}.jpg" bigImageURL="img/productSingle/${productImage.id}.jpg" class="smallImage">
            </c:forEach>
        </div>
