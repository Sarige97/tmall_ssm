        ...
        <div class="reviewDivlistReviews">
            <c:forEach items="${reviews}" var="reviews">
                <div class="reviewDivlistReviewsEach">
                    <div class="reviewDate"><fmt:formatDate value="${reviews.createDate}" pattern="yyyy-MM-dd"/></div>
                    <div class="reviewContent">${reviews.content}</div>
                    <div class="reviewUserInfo pull-right">${reviews.user.anonymousName}<span class="reviewUserInfoAnonymous">(匿名)</span></div>
                </div>
            </c:forEach>
        </div>
    </c:if>
